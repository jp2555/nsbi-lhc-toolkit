...
\begin{enumerate}
\item \textbf{Statistics where it matters.} The Family-1 ratio is hard (genuinely different distributions) but
  is trained \emph{once}, on the full nominal MC (the ample $\approx$500--750k events per \kl\ point). The
  Family-2 ratios are \emph{easy} (two nearly identical distributions, ratio $\approx1$) --- which is what makes
  them learnable at all from the smaller $\pm1\sigma$ samples.
